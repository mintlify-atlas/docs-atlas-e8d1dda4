---
title: "Payment Saga: Intent, Webhook, and Compensation"
sidebarTitle: "Payments"
description: "How the payment saga creates an intent, settles via webhook, confirms the consultation on success, and cancels with slot compensation on failure — all idempotently."
---
